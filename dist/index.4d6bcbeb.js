...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./App":"2kQhy","./routes":"3L9mC"}],"gkKU3":[function(require,module,exports) {
...
class TheHeader extends (0, _heropy.Component) {
    ...
    render() {
      ...
      <a href="#/about" class="user">
        <img src="https://techworld.speedgabia.com/newsletter/2024/ad/minji.ico" alt="User">
      </a>
    `;
    }
}
    ...
    render() {
      ...
      <div>
        <a href="${github}">
          ...
          Minji.D is using for java script practise
        </a>
      </div>
    `;
    }
...
exports.default = new (0, _heropy.Store)({
    photo: "https://techworld.speedgabia.com/newsletter/2024/ad/minji.ico",
    name: "Minj.D",
    email: "minjee9009@gmail.com"
});
...
const searchMovies = async (page)=>{
    ...
    try {
        ...
        // api iin hayg ? iin temdegiin araas api keygee biched  araas ni${haih yma biched} 
        const res = await fetch(`https://omdbapi.com?apikey=7035c60c&s=${store.state.searchText}&page=${page}`, {
            method: "POST",
            body: JSON.stringify({
...
class About extends (0, _heropy.Component) {
    render() {
      ...
      <p>Just did for practice. Watching FastCampus Heropy</p>
...
},{"../core/heropy":"57bZf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["anvqh","gLLPy"], "gLLPy", "parcelRequireb88e")
